...
describe('LocationService', () => {
  ...
  it('should get countries', () => {
    ...
    const req = httpMock.expectOne(`${environment.url_commons}/countries`);
  ...
  it('should get regions', () => {
    ...
    const req = httpMock.expectOne(`${environment.url_commons}/regions/country/1`);
    expect(req.request.method).toBe('GET');
  ...
  it('should get city', () => {
    ...
    const req = httpMock.expectOne(`${environment.url_commons}/cities/region/1`);
    expect(req.request.method).toBe('GET');
